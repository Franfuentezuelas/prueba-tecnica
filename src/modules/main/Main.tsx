  ...
  return (
    <main className={styles.container}>
      <div className={styles.secondRow}>
        ...
        {pasoActual === 'datos' && <Formulario setDatosCorrectos={setDatosForm} />}

        {pasoActual === 'envio' && <Envio setDatosEnvio={setDatosEnvio} />}

        {pasoActual === 'pago' && <Pago setDatosPago={setDatosPago} />}

        {pasoActual === 'final' && <Finalizar setDatosFinal={setDatosFinal} />}
      </div>
    </main>
  )
}
